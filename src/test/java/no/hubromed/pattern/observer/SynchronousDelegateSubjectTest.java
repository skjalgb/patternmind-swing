 ...
 * @since Sep 24, 2010
 */
public class SynchronousDelegateSubjectTest {
    ...
    private class SomeClassThatAlreadyExtendsSomething extends Date implements Subject<Field, SomeClassThatAlreadyExtendsSomething> {
        SynchronousSubject<Field, SomeClassThatAlreadyExtendsSomething> delegate =
                new SynchronousSubject<Field, SomeClassThatAlreadyExtendsSomething>(this);
